...
type Spacing = {
  // Optional as we don't want to always use all the properties, but
  // a few of them, selectively as needed.
  [Key in GapCss]?: SizeCss;
};

const h: Spacing = {
  "padding-top": "2rem", // OK
  "padding-bottom": "1rim", // NOK
  // ~ Type '"1ram"' is not assignable to type
